        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    INNER JOIN user ON user.user_id = post.author WHERE post.category = {$cat_id} ORDER BY post.post_id DESC LIMIT {$offset}, {$limit}";
                    ...
                    <?php
                    $pagiSql = "SELECT * FROM post WHERE category = {$cat_id}";
                    ...
                    ?>
                        <ul class='pagination admin-pagination'>
                            ...
                            <?php if ($page > 1) { ?>
                                <li><a href="<?php echo base_url; ?>/category.php?cat_id=<?php echo $cat_id; ?>&page=<?php echo $page - 1; ?>"> <i class="fa fa-long-arrow-left" aria-hidden="true"></i> </a></li>
                            <?php } ?>

                            <?php for ($i = 1; $i <= $total_pages; $i++) { ?>
                                <li><a class="<?php echo ($page == $i) ? 'active' : '' ?>" href="<?php echo base_url; ?>/category.php?cat_id=<?php echo $cat_id; ?>&page=<?php echo $i; ?>"> <?php echo $i; ?> </a></li>
                            <?php } ?>

                            <?php if ($total_pages > $page) { ?>
                                <li><a href="<?php echo base_url; ?>/category.php?cat_id=<?php echo $cat_id; ?>&page=<?php echo $page + 1; ?>"> <i class="fa fa-long-arrow-right" aria-hidden="true"></i> </a></li>
                            <?php } ?>
                        </ul>
                    <?php } ?>
                </div><!-- /post-container -->
